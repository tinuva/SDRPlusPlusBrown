...
//        }
        ...
        // Initialize VFO
        vfo = sigpath::vfoManager.createVFO(name, ImGui::WaterfallVFO::REF_UPPER, 0, 9600, INPUT_SAMPLE_RATE, 9600, 9600, true);
...
private:
    static void menuHandler(void* ctx) {
        DSDCCDecoderModule* _this = (DSDCCDecoderModule*)ctx;
...
//            }
//
//            ImGui::BeginTable(CONCAT("##dsdcc_info_tbl_", _this->name), 2, ImGuiTableFlags_SizingFixedFit | ImGuiTableFlags_RowBg | ImGuiTableFlags_Borders);
//            if (!_this->lsf.valid) {
//                ImGui::TableNextRow();
...
//                ImGui::TextUnformatted("Data Type");
//                ImGui::TableSetColumnIndex(1);
//                ImGui::TextUnformatted(DSDCCDataTypesTxt[_this->lsf.dataType]);
//
//                ImGui::TableNextRow();
//                ImGui::TableSetColumnIndex(0);
//                ImGui::TextUnformatted("Encryption");
//                ImGui::TableSetColumnIndex(1);
//                ImGui::Text("%s (Subtype %d)", DSDCCEncryptionTypesTxt[_this->lsf.encryptionType], _this->lsf.encryptionSubType);
//
//                ImGui::TableNextRow();
//                ImGui::TableSetColumnIndex(0);
//                ImGui::TextUnformatted("CAN");
...
//        }
//
//        if (ImGui::Checkbox(CONCAT("Show Reference Lines##dsdcc_showlines_", _this->name), &_this->showLines)) {
//            if (_this->showLines) {
...
//    static void lsfHandler(DSDCCLSF& lsf, void* ctx) {
//        DSDCCDecoderModule* _this = (DSDCCDecoderModule*)ctx;
//        std::lock_guard lck(_this->lsfMtx);
...
MOD_EXPORT void _INIT_() {
    ...
    json def = json({});
    config.setPath(core::args["root"].s() + "/dsdcc_decoder_config.json");
    config.load(def);
